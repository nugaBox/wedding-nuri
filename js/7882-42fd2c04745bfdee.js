                ...
                var c = [
                    ...
                    f = function (e, t) {
                        ...
                        return (
                            ...
                            n.useEffect(
                                function () {
                                    if (R.current) {
                                        ...
                                        Array.isArray(m) &&
                                            m.length &&
                                            ((R.current.currentRawFrame < m[0] || R.current.currentRawFrame > m[1]) && (R.current.currentRawFrame = m[0]), R.current.setSegment(m[0], m[1]));
                                    }
                                },
                                [m]
                            ),
                                ...
                                function () {
                                    ...
                                    if (e.length) {
                                        var t = e.map(function (e) {
                                            var t;
                                            return (
                                                null === (t = R.current) || void 0 === t || t.addEventListener(e.name, e.handler),
                                                function () {
                                                    var t;
                            ...
                            {
                                View: i.default.createElement("div", u({ style: t, ref: L }, j)),
                                play: function () {
                                    var e;
                                            ...
                                            return (
                                                ...
                                                (n = function () {
                                                    var t,
                                                        n,
                                                        o,
                                                        a = ((n = (t = s.getBoundingClientRect()).top), (o = t.height), (window.innerHeight - n) / (window.innerHeight + o)),
                                                        u = i.find(function (e) {
                                                            var t = e.visibility;
                                                    ...
                                                    if (u) {
                                                        ...
                                                        ("loop" === u.type &&
                                                            (null === e
                                                                ...
                                                                : e !== u.frames
                                                                  ? (r.playSegments(u.frames, !0), (e = u.frames))
                                                                  : r.isPaused && (r.playSegments(u.frames, !0), (e = u.frames))),
                                                            "play" === u.type && r.isPaused && (r.resetSegments(!0), r.play()),
                                                ...
                                                (a = function (e, t) {
                                                    ...
                                                    if (-1 !== n && -1 !== o) {
                                                        var a,
                                                            ...
                                                            l,
                                                            c,
                                                            f = ((a = n), (u = o), (c = (l = s.getBoundingClientRect()).top), { x: (a - l.left) / l.width, y: (u - c) / l.height });
                                                        ((n = f.x), (o = f.y));
                                                    }
                                                    var d = i.find(function (e) {
                                                        var t = e.position;
                                                        return t && Array.isArray(t.x) && Array.isArray(t.y)
                                                            ? n >= t.x[0] && n <= t.x[1] && o >= t.y[0] && o <= t.y[1]
                                                            : !(!t || Number.isNaN(t.x) || Number.isNaN(t.y)) && n === t.x && o === t.y;
                                                    });
                                                    if (d) {
                                                        ...
                                                        ("loop" === d.type && r.playSegments(d.frames, !0),
                                                            "play" === d.type && (r.isPaused && r.resetSegments(!1), r.playSegments(d.frames)),
                                                            "stop" === d.type && r.goToAndStop(d.frames[0], !0));
                                                    }
                                                }),
                                                (u = function (e) {
                    ...
                    m = function (e) {
                        var t = e.actions,
                            ...
                            o = r.animationItem,
                            i = r.View;
                        return (d({ actions: t, animationItem: o, mode: n, wrapperRef: r.animationContainerRef }), i);
                    },
