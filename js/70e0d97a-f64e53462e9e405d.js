        ...
        79006: function (e, t, n) {
            ...
            function z(e, t, n) {
                ...
                for (let r = n || e.dom; r; r = l(r)) {
                    ...
                    let e = r,
                        n = e == s.body,
                        l = n
                            ? { left: 0, right: s.documentElement.clientWidth, top: 0, bottom: s.documentElement.clientHeight }
                            : (function (e) {
                    ...
                    if (
                        (t.top < l.top + q(o, "top")
                            ...
                            : t.bottom > l.bottom - q(o, "bottom") && (a = t.bottom - t.top > l.bottom - l.top ? t.top + q(i, "top") - l.top : t.bottom - l.bottom + q(i, "bottom")),
                        t.left < l.left + q(o, "left") ? (d = -(l.left - t.left + q(i, "left"))) : t.right > l.right - q(o, "right") && (d = t.right - l.right + q(i, "right")),
                        d || a)
                    ) {
                ...
                if (3 == o.nodeType) {
                    ...
                    }
                    {
                        let e = i,
                            t = i,
                            s = n < 0 ? 1 : -1;
                        return (n < 0 && !i ? (t++, (s = -1)) : n >= 0 && i == o.nodeValue.length ? (e--, (s = 1)) : n < 0 ? e-- : t++, Y($(a(o, e, t), s), s < 0));
                    }
                }
            ...
            class Z {
                ...
                domFromPos(e, t) {
                    ...
                    for (let e; n && !(e = this.children[n - 1]).size && e instanceof ee && e.side >= 0; n--);
                    if (t <= 0) {
                        let e,
                            o = !0;
            ...
            class en extends Z {
                ...
                static create(e, t, n, o) {
                    let s = o.nodeViews[t.type.name],
                        r = s && s(t, o, n);
                    return ((r && r.dom) || (r = i.PW.renderSpec(document, t.type.spec.toDOM(t, n))), new en(e, t, r.dom, r.contentDOM || r.dom));
                }
                parseRule() {
            ...
            class eo extends Z {
                ...
                static create(e, t, n, o, s, r) {
                    ...
                    } else c || ({ dom: c, contentDOM: h } = i.PW.renderSpec(document, t.type.spec.toDOM(t)));
                    h || t.isText || "BR" == c.nodeName || (c.hasAttribute("contenteditable") || (c.contentEditable = "false"), t.type.spec.draggable && (c.draggable = !0));
                    let u = c;
                    return ((c = eu(c, n, t)), a) ? (d = new el(e, t, n, o, c, h || null, u, a, s, r + 1)) : t.isText ? new es(e, t, n, o, c, u, s) : new eo(e, t, n, o, c, h || null, u, s, r + 1);
                }
                parseRule() {
                ...
                matchesNode(e, t, n) {
                    return 0 == this.dirty && e.eq(this.node) && ef(t, this.outerDeco) && n.eq(this.innerDeco);
                }
                get size() {
                ...
                protectLocalComposition(e, { node: t, pos: n, text: o }) {
                    ...
                    (e.input.compositionNodes.push(s), (this.children = ey(this.children, n, n + o.length, e, s)));
                }
                update(e, t, n, o) {
                ...
                updateOuterDeco(e) {
                    ...
                    let t = 1 != this.nodeDOM.nodeType,
                        n = this.dom;
                    ((this.dom = eh(this.dom, this.nodeDOM, ec(this.outerDeco, this.node, t), ec(e, this.node, t))),
            ...
            class es extends eo {
                ...
                slice(e, t, n) {
                    ...
                    return new es(this.parent, o, this.outerDeco, this.innerDeco, i, i, n);
                }
                markDirty(e, t) {
                ...
                for (let s = 0; s < e.length; s++) {
                    ...
                    if (r)
                        for (let e in (r.nodeName && i.push((o = new ed(r.nodeName))), r)) {
                            let s = r[e];
                            null != s &&
                                (n && 1 == i.length && i.push((o = new ed(t.isInline ? "span" : "div"))),
            ...
            function eh(e, t, n, o) {
                ...
                for (let t = 0; t < o.length; t++) {
                    ...
                    if (t) {
                        let t;
                        ((r && r.nodeName == s.nodeName && i != e && (t = i.parentNode) && t.nodeName.toLowerCase() == s.nodeName) ||
                            (((t = document.createElement(s.nodeName)).pmIsDeco = !0), t.appendChild(i), (r = ea[0])),
                            (i = t));
                    }
                    !(function (e, t, n) {
            ...
            class em {
                ...
                updateNextNode(e, t, n, o, i, s) {
                    for (let r = this.index; r < this.top.children.length; r++) {
                        ...
                        if (l instanceof eo) {
                            ...
                            let a = l.dom,
                                c,
                                h = this.isLocked(a) && !(e.isText && l.node && l.node.isText && l.nodeDOM.nodeValue == e.text && 3 != l.dirty && ef(t, l.outerDeco));
                ...
                addTextblockHacks() {
                    ...
                    (!e || !(e instanceof es) || /\n$/.test(e.node.text) || (this.view.requiresGeckoHackNode && /\s$/.test(e.node.text))) &&
                        ((T || x) && e && "false" == e.dom.contentEditable && this.addHackNode("IMG", t), this.addHackNode("BR", this.top));
                }
                addHackNode(e, t) {
                ...
                if ((eC(e, n), ev(e))) {
                    ...
                    if ((e.domObserver.disconnectSelection(), e.cursorWrapper)) {
                        ...
                        ((t = e.domSelection()),
                            ...
                            t.removeAllRanges(),
                            t.addRange(n),
                            !i && !e.state.selection.visible && O && S <= 11 && ((o.disabled = !0), (o.disabled = !1)));
                    } else {
                        let i,
                            s,
                            r,
                            ...
                            c,
                            h;
                        (!eD || n instanceof o.Bs || (n.$from.parent.inlineContent || (c = eN(e, n.from)), n.empty || n.$from.parent.inlineContent || (h = eN(e, n.to))),
            ...
            function eC(e, t) {
                if (t instanceof o.qv) {
                    ...
                    n != e.lastSelectedViewDesc && (eM(e), n && n.selectNode(), (e.lastSelectedViewDesc = n));
                } else eM(e);
            }
            function eM(e) {
                ...
                if (i instanceof o.Bs) {
                    ...
                    if (!(E && n.indexOf("m") > -1)) {
                        ...
                        return (
                            ...
                            (o.qv.isSelectable(s) ? eE(e, new o.qv(t < 0 ? e.state.doc.resolve(n.pos - s.nodeSize) : n)) : !!R && eE(e, new o.Bs(e.state.doc.resolve(t < 0 ? l : l + s.nodeSize))))
                        );
                    }
                } else {
                    if (i instanceof o.qv && i.node.isInline) return eE(e, new o.Bs(t > 0 ? i.$to : i.$from));
                    let n = eP(e.state, t);
                    return !!n && eE(e, n);
                }
            }
                ...
                return t < 0
                    ? (function (e) {
                          ...
                          let i,
                              s,
                              l = !1;
                          for (C && 1 == n.nodeType && o < eV(n) && eR(n.childNodes[o], -1) && (l = !0); ; )
                              if (o > 0) {
                                  ...
                                  for (; t && eR(t, -1); ) ((i = n.parentNode), (s = r(t)), (t = t.previousSibling));
                                  if (t) o = eV((n = t));
                                  else {
                    ...
                    : (function (e) {
                          ...
                          for (;;)
                              if (s < l) {
                                  ...
                                  let o = i.nextSibling;
                                  for (; o && eR(o, 1); ) ((t = o.parentNode), (n = r(o) + 1), (o = o.nextSibling));
                                  if (o) ((s = 0), (l = eV((i = o))));
                                  else {
            ...
            function ez(e, t, n) {
                if (3 != t.nodeType) {
                    let e, o;
                    (o = (function (e, t) {
                        for (; e && t == e.childNodes.length && !p(e); ) ((t = r(e) + 1), (e = e.parentNode));
            ...
            function eL(e, t, n) {
                let i = e.state.selection;
                if ((i instanceof o.Bs && !i.empty) || n.indexOf("s") > -1 || (E && n.indexOf("m") > -1)) return !1;
                let { $from: s, $to: r } = i;
                ...
                if (
                    (l ||
                        (l = (e.someProp("clipboardParser") || e.someProp("domParser") || i.aw.fromSchema(e.state.schema)).parseSlice(r, {
                            ...
                            context: s,
                            ruleFromNode: e => ("BR" != e.nodeName || e.nextSibling || !e.parentNode || eH.test(e.parentNode.nodeName) ? null : { ignore: !0 }),
                        })),
                    h)
                )
                    l = (function (e, t) {
                                                ...
                                                (function e(t, n, o, s, r) {
                                                    if (r < t.length && r < n.length && t[r] == n[r]) {
                                                        ...
                                                        if (s.contentMatchAt(s.childCount).matchType(r == t.length - 1 ? o.type : t[r + 1]))
                                                            return s.copy(s.content.append(i.HY.from(e_(o, t, r + 1))));
                                                    }
            ...
            function eG(e, t, n) {
                return (
                    t < e.openStart && (e = new i.p2(eY(e.content, -1, t, e.openStart, 0, e.openEnd), t, e.openEnd)),
                    n < e.openEnd && (e = new i.p2(eY(e.content, 1, n, e.openEnd, 0, 0), e.openStart, n)),
                    e
                );
            }
            let eU = {
            ...
            function e2(e) {
                e.someProp("handleDOMEvents", t => {
                    for (let n in t) e.input.eventHandlers[n] || e.dom.addEventListener(n, (e.input.eventHandlers[n] = t => e3(e, t)));
                });
            }
            function e3(e, t) {
            ...
            ((eQ.keydown = (e, t) => {
                if (((e.input.shiftKey = 16 == t.keyCode || t.shiftKey), !e4(e, t) && ((e.input.lastKeyCode = t.keyCode), (e.input.lastKeyCodeTime = Date.now()), !V || !x || 13 != t.keyCode))) {
                    if ((229 != t.keyCode && e.domObserver.forceFlush(), !P || 13 != t.keyCode || t.ctrlKey || t.altKey || t.metaKey))
                        ...
                        (function (e, t) {
                            ...
                            if (8 == o || (E && 72 == o && "c" == i)) return eF(e, -1) || eB(e, -1);
                            if ((46 == o && !t.shiftKey) || (E && 68 == o && "c" == i)) return eF(e, 1) || eB(e, 1);
                            ...
                            if (38 == o || (E && 80 == o && "c" == i)) return eL(e, -1, i) || eB(e, -1);
                            if (40 == o || (E && 78 == o && "c" == i))
                                return (
                                    (function (e) {
                            ...
                            else if (i == (E ? "m" : "c") && (66 == o || 73 == o || 89 == o || 90 == o)) return !0;
                            return !1;
                        })(e, t)
                            ? t.preventDefault()
                            : e1(e, "key");
                ...
                (eQ.keypress = (e, t) => {
                    if (e4(e, t) || !t.charCode || (t.ctrlKey && !t.altKey) || (E && t.metaKey)) return;
            ...
            eJ.mousedown = (e, t) => {
                ...
                a &&
                    ("singleClick" == d
                        ? (e.input.mouseDown && e.input.mouseDown.done(), (e.input.mouseDown = new e7(e, a, t, !!r)))
                        : ("doubleClick" == d
                                ? function (e, t, n, o) {
                                      return e6(e, "handleDoubleClickOn", t, n, o) || e.someProp("handleDoubleClick", n => n(e, t, o));
                                  }
                                : function (e, t, n, i) {
                                      return (
                                          ...
                                          (function (e, t, n) {
                                              ...
                                              let i = e.state.doc;
                                              if (-1 == t) return !!i.inlineContent && (e8(e, o.Bs.create(i, 0, i.content.size), "pointer"), !0);
                                              let s = i.resolve(t);
                                              for (let t = s.depth + 1; t > 0; t--) {
                                                  let n = t > s.depth ? s.nodeAfter : s.node(t),
                                                      r = s.before(t);
                                                  if (n.inlineContent) e8(e, o.Bs.create(i, r + 1, r + 1 + n.content.size), "pointer");
                                                  else {
            ...
            class e7 {
                constructor(e, t, n, i) {
                    ...
                    (((0 == n.button && s.type.spec.draggable && !1 !== s.type.spec.selectable) || (a instanceof o.qv && a.from <= r && a.to > r)) &&
                        (this.mightDrag = { node: s, pos: r, addAttr: !!(this.target && !this.target.draggable), setUneditable: !!(this.target && C && !this.target.hasAttribute("contentEditable")) }),
                        this.target &&
                            this.mightDrag &&
                ...
                up(e) {
                    ...
                    let t = this.pos;
                    if ((this.view.state.doc != this.startDoc && (t = this.view.posAtCoords(e5(e))), this.updateAllowDefault(e), this.allowDefault || !t)) e1(this.view, "pointer");
                    else {
                        var n, i, s, r;
                        ((n = this.view),
                        (i = t.pos),
                        ...
                        e6(n, "handleClickOn", i, s, e) ||
                            ...
                            (r
                                ? (function (e, t) {
                                      ...
                                      return null != s && (e8(e, o.qv.create(e.state.doc, s), "pointer"), !0);
                                  })(n, s)
                                : (function (e, t) {
                                      if (-1 == t) return !1;
                                      let n = e.state.doc.resolve(t),
                                          i = n.nodeAfter;
                                      return !!(i && i.isAtom && o.qv.isSelectable(i)) && (e8(e, new o.qv(n), "pointer"), !0);
                                  })(n, s)))
                            ? e.preventDefault()
                            : 0 == e.button &&
                                (this.flushed ||
                                    (T && this.mightDrag && !this.mightDrag.node.isAtom) ||
                                    (x && !this.view.state.selection.visible && 2 >= Math.min(Math.abs(t.pos - this.view.state.selection.from), Math.abs(t.pos - this.view.state.selection.to))))
                              ? (e8(this.view, o.Y1.near(this.view.state.doc.resolve(t.pos)), "pointer"), e.preventDefault())
                              : e1(this.view, "pointer");
                    }
                }
                move(e) {
                    (this.updateAllowDefault(e), e1(this.view, "pointer"), 0 == e.buttons && this.done());
                }
            ...
            function e4(e, t) {
                return !!e.composing || (!!(T && 500 > Math.abs(t.timeStamp - e.input.compositionEndedAt)) && ((e.input.compositionEndedAt = -2e8), !0));
            }
            ((eJ.touchstart = e => {
            ...
            function tn(e) {
                let t;
                for (
                    e.composing && ((e.input.composing = !1), (e.input.compositionEndedAt = ((t = document.createEvent("Event")).initEvent("event", !0, !0), t.timeStamp)));
            ...
            function to(e, t = !1) {
                if (!V || !(e.domObserver.flushingSoon >= 0)) {
                    if ((e.domObserver.forceFlush(), tn(e), t || (e.docView && e.docView.dirty))) {
                        let t = eb(e);
                ...
                e => {
                    if (!e.composing) {
                        ...
                        if (t.selection.empty && (t.storedMarks || (!n.textOffset && n.parentOffset && n.nodeBefore.marks.some(e => !1 === e.type.spec.inclusive))))
                            ((e.markCursor = e.state.storedMarks || n.marks()), to(e, !0), (e.markCursor = null));
                        else if ((to(e), C && t.selection.empty && n.parentOffset && !n.textOffset && n.nodeBefore.marks.length)) {
                            let t = e.domSelectionRange();
                ...
                (eQ.paste = (e, t) => {
                    ...
                    n && ts(e, tr(n), n.getData("text/html"), o, t)
                        ...
                        : (function (e, t) {
                              ...
                              setTimeout(() => {
                                  (e.focus(), o.parentNode && o.parentNode.removeChild(o), n ? ts(e, o.value, null, i, t) : ts(e, o.textContent, o.innerHTML, i, t));
                              }, 50);
                          })(e, t);
                }));
            class tl {
            ...
            (eQ.drop = (e, t) => {
                ...
                d
                    ...
                    : (d = e$(e, tr(t.dataTransfer), ti ? null : t.dataTransfer.getData("text/html"), !1, l));
                let a = !!(n && !t[td]);
                ...
                if (f && o.qv.isSelectable(d.content.firstChild) && m.nodeAfter && m.nodeAfter.sameMarkup(d.content.firstChild)) h.setSelection(new o.qv(m));
                    ...
                    (h.mapping.maps[h.mapping.maps.length - 1].forEach((e, n, o, i) => (t = i)), h.setSelection(ex(e, m, h.doc.resolve(t))));
                }
            ...
            (eJ.focus = e => {
                ((e.input.lastFocus = Date.now()),
                    e.focused ||
                        ...
                        (e.focused = !0),
                        setTimeout(() => {
                            e.docView && e.hasFocus() && !e.domObserver.currentSelection.eq(e.domSelectionRange()) && ew(e);
                        }, 20)));
            }),
            (eJ.blur = (e, t) => {
                e.focused &&
            ...
            (eJ.beforeinput = (e, t) => {
                if (x && V && "deleteContentBackward" == t.inputType) {
                    ...
                    setTimeout(() => {
                        if (e.input.domChangeCount != t || (e.dom.blur(), e.focus(), e.someProp("handleKeyDown", t => t(e, g(8, "Backspace"))))) return;
            ...
            class tc {
                constructor(e, t) {
                    ((this.toDOM = e), (this.spec = t || tm), (this.side = this.spec.side || 0));
                }
                map(e, t, n, o) {
                ...
                eq(e) {
                    return this == e || (e instanceof tc && ((this.spec.key && this.spec.key == e.spec.key) || (this.toDOM == e.toDOM && ta(this.spec, e.spec))));
                }
                destroy(e) {
            ...
            class th {
                ...
                eq(e) {
                    return this == e || (e instanceof th && ta(this.attrs, e.attrs) && ta(this.spec, e.spec));
                }
                static is(e) {
            ...
            class tu {
                ...
                map(e, t, n, o) {
                    ...
                    return s.deleted || s.pos <= i.pos ? null : new tf(i.pos - n, s.pos - n, this);
                }
                valid(e, t) {
                ...
                eq(e) {
                    return this == e || (e instanceof tu && ta(this.attrs, e.attrs) && ta(this.spec, e.spec));
                }
                destroy() {}
            }
            class tf {
            ...
            class tg {
                ...
                map(e, t, n) {
                    return this == ty || 0 == e.maps.length ? this : this.mapInner(e, t, 0, 0, n || tm);
                }
                mapInner(e, t, n, o, i) {
                    let s;
                              ...
                              for (let t = 0; t < l.length; t += 3)
                                  if (l[t + 1] < 0) {
                                      ...
                                      if (p && f == c && f + p.nodeSize == h) {
                                          ...
                                          o != ty ? ((l[t] = c), (l[t + 1] = h), (l[t + 2] = o)) : ((l[t + 1] = -2), (d = !0));
                                      } else d = !0;
                                  }
                              if (d) {
                                  let d = tN(
                ...
                add(e, t) {
                    return t.length ? (this == ty ? tg.create(e, t) : this.addInner(e, t, 0)) : this;
                }
                addInner(e, t, n) {
                    let o,
                        i = 0;
                    e.forEach((e, s) => {
                        ...
                        if ((l = tw(t, e, r))) {
                            ...
                            (o[i] == s ? (o[i + 2] = o[i + 2].addInner(e, l, r + 1)) : o.splice(i, 0, s, s + e.nodeSize, tN(l, e, r + 1, tm)), (i += 3));
                        }
                    });
                    let s = tv(i ? tD(t) : t, -n);
                    for (let t = 0; t < s.length; t++) s[t].type.valid(e, s[t]) || s.splice(t--, 1);
                    return new tg(s.length ? this.local.concat(s).sort(tO) : this.local, o || this.children);
                }
                remove(e) {
                ...
                removeInner(e, t) {
                    ...
                    return n == this.children && o == this.local ? this : o.length || n.length ? new tg(o, n) : ty;
                }
                forChild(e, t) {
                    let n, o;
                ...
                eq(e) {
                    if (this == e) return !0;
                    if (!(e instanceof tg) || this.local.length != e.local.length || this.children.length != e.children.length) return !1;
                ...
                localsInner(e) {
                    ...
                    let t = [];
                    for (let e = 0; e < this.local.length; e++) this.local[e].type instanceof th || t.push(this.local[e]);
                    return t;
                }
            }
            ...
            class tb {
                ...
                forChild(e, t) {
                    ...
                    for (let o = 0; o < this.members.length; o++) {
                        ...
                        i != ty && (i instanceof tb ? (n = n.concat(i.members)) : n.push(i));
                    }
                    return tb.from(n);
                }
                eq(e) {
                    if (!(e instanceof tb) || e.members.length != this.members.length) return !1;
                ...
                static from(e) {
                    switch (e.length) {
                        ...
                        case 1:
                            return e[0];
                        default:
                            return new tb(e.every(e => e instanceof tg) ? e : e.reduce((e, t) => e.concat(t instanceof tg ? t : t.members), []));
                    }
                }
            }
            function tv(e, t) {
                ...
                for (let n = 0; n < t.length - 1; n++) {
                    ...
                    if (o.from != o.to)
                        for (let i = n + 1; i < t.length; i++) {
                            let s = t[i];
                            if (s.from == o.from) {
                                s.to != o.to && (t == e && (t = e.slice()), (t[i] = s.copy(s.from, o.to)), tC(t, i + 1, s.copy(o.to, s.to)));
                                continue;
                            }
                            s.from < o.to && (t == e && (t = e.slice()), (t[n] = o.copy(o.from, s.from)), tC(t, i, o.copy(s.from, o.to)));
                            break;
                        }
                }
                return t;
            ...
            function tM(e) {
                ...
                return (
                    ...
                    e.cursorWrapper && t.push(tg.create(e.state.doc, [e.cursorWrapper.deco])),
                    tb.from(t)
                );
            }
            let tx = { childList: !0, characterData: !0, characterDataOldValue: !0, attributes: !0, attributeOldValue: !0, subtree: !0 },
                tk = O && S <= 11;
            class tT {
                constructor() {
            ...
            class tP {
                    ...
                    ((this.view = e),
                        ...
                        (this.observer =
                            ...
                            new window.MutationObserver(e => {
                                ...
                                O && S <= 11 && e.some(e => ("childList" == e.type && e.removedNodes.length) || ("characterData" == e.type && e.oldValue.length > e.target.nodeValue.length))
                                    ? this.flushSoon()
                                    : this.flush();
                            })),
                        tk &&
                ...
                start() {
                    (this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, tx)),
                ...
                flush() {
                    ...
                    t.length && (this.queue = []);
                    let n = e.domSelectionRange(),
                        i = !this.suppressingSelectionUpdates && !this.currentSelection.eq(n) && ek(e) && !this.ignoreSelectionChange(n),
                        s = -1,
                        r = -1,
                        l = !1,
                        d = [];
                    ...
                    a.eq(o.Y1.near(e.state.doc.resolve(0), 1))
                        ? ((e.input.lastFocus = 0), ew(e), this.currentSelection.set(n), e.scrollToSelection())
                        : (s > -1 || i) &&
                          (s > -1 &&
                              (e.docView.markDirty(s, r),
                              tE.has(e) ||
                                  (tE.set(e, null), -1 === ["normal", "nowrap", "pre-line"].indexOf(getComputedStyle(e.dom).whiteSpace)) ||
                          ...
                          e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(n) || ew(e),
                ...
                registerMutation(e, t) {
                    ...
                    if (
                        ("attributes" == e.type &&
                            (n == this.view.docView || "contenteditable" == e.attributeName || ("style" == e.attributeName && !e.oldValue && !e.target.getAttribute("style")))) ||
                        !n ||
                        n.ignoreMutation(e)
                    )
                        return null;
            ...
            function tV(e) {
                ...
                if ("BR" == e.nodeName && e.parentNode) {
                    ...
                    if (e.parentNode.lastChild == e || (T && /^(tr|table)$/i.test(e.parentNode.nodeName))) return { ignore: !0 };
                } else if ("IMG" == e.nodeName && e.getAttribute("mark-placeholder")) return { ignore: !0 };
                return null;
            }
            let tR = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
            function tB(e, t, n) {
                return Math.max(n.anchor, n.head) > t.content.size ? null : ex(e, t.resolve(n.anchor), t.resolve(n.head));
            }
            function tq(e, t, n) {
                let o = e.depth,
                    i = t ? e.end() : e.pos;
            ...
            class tI {
                constructor(e, t) {
                    ((this._root = null),
                        ...
                        (this.docView = ei(this.state.doc, tL(this), tM(this), this.dom, this)),
                        (this.domObserver = new tP(this, (e, t, n, s) =>
                            (function (e, t, n, s, r) {
                                ...
                                let p = e.state.doc.resolve(t),
                                    y = p.sharedDepth(n);
                                ((t = p.before(y + 1)), (n = e.state.doc.resolve(n).after(y + 1)));
                                    ...
                                    v = (function (e, t, n) {
                                        ...
                                        if (
                                            (h &&
                                                ...
                                                ((o = [{ node: h, offset: c.anchorOffset }]), m(c) || o.push({ node: c.focusNode, offset: c.focusOffset })),
                                ...
                                (8 === e.input.lastKeyCode && Date.now() - 100 < e.input.lastKeyCodeTime ? ((l = e.state.selection.to), (d = "end")) : ((l = e.state.selection.from), (d = "start")),
                                ...
                                let N = (function (e, t, n, o, i) {
                                    ...
                                    if (r < s && e.size < t.size) {
                                        let e = o <= s && o >= r ? s - o : 0;
                                        ((s -= e) && s < t.size && tz(t.textBetween(s - 1, s + 1)) && (s += e ? 1 : -1), (l = s + (l - r)), (r = s));
                                    } else if (l < s) {
                                        let t = o <= s && o >= l ? s - o : 0;
                                        ((s -= t) && s < e.size && tz(e.textBetween(s - 1, s + 1)) && (s += t ? 1 : -1), (r = s + (r - l)), (l = s));
                                    }
                                ...
                                if (!N) {
                                    if (s && b instanceof o.Bs && !b.empty && b.$head.sameParent(b.$anchor) && !e.composing && !(v.sel && v.sel.anchor != v.sel.head))
                                ...
                                if (x && e.cursorWrapper && v.sel && v.sel.anchor == e.cursorWrapper.deco.from && v.sel.head == v.sel.anchor) {
                                    ...
                                    e.state.selection.from < e.state.selection.to &&
                                        ...
                                        (N.start > e.state.selection.from && N.start <= e.state.selection.from + 2 && e.state.selection.from >= v.from
                                            ...
                                            : N.endA < e.state.selection.to &&
                                              ...
                                              ((N.endB += e.state.selection.to - N.endA), (N.endA = e.state.selection.to))),
                                    O &&
                                        S <= 11 &&
                                        N.endB == N.start + 1 &&
                                        N.endA == N.start &&
                                        N.start > v.from &&
                                        " \xa0" == v.doc.textBetween(N.start - v.from - 1, N.start - v.from + 1) &&
                                        (N.start--, N.endA--, N.endB--));
                                let C = v.doc.resolveNoCache(N.start - v.from),
                                    M = v.doc.resolveNoCache(N.endB - v.from),
                                    k = w.resolve(N.start),
                                    T = C.sameParent(M) && C.parent.inlineContent && k.end() >= N.endA;
                                if (
                                    ((P && e.input.lastIOSEnter > Date.now() - 225 && (!T || r.some(e => "DIV" == e.nodeName || "P" == e.nodeName))) ||
                                        (!T && C.pos < v.doc.content.size && !C.sameParent(M) && (a = o.Y1.findFrom(v.doc.resolve(C.pos + 1), 1, !0)) && a.head == M.pos)) &&
                                    e.someProp("handleKeyDown", t => t(e, g(13, "Enter")))
                                ) {
                                    e.input.lastIOSEnter = 0;
                                    return;
                                ...
                                if (
                                    ...
                                    (function (e, t, n, o, i) {
                                        if (!o.parent.isTextblock || n - t <= i.pos - o.pos || tq(o, !0, !1) < i.pos) return !1;
                                        let s = e.resolve(t);
                                        if (s.parentOffset < s.parent.content.size || !s.parent.isTextblock) return !1;
                                        let r = e.resolve(tq(s, !0, !0));
                                        return !(!r.parent.isTextblock || r.pos > n || tq(r, !0, !1) < n) && o.parent.content.cut(o.parentOffset).eq(r.parent.content);
                                ...
                                (x && V && N.endB == N.start && (e.input.lastAndroidDelete = Date.now()),
                                    V &&
                                        !T &&
                                        C.start() != M.start() &&
                                        0 == M.parentOffset &&
                                ...
                                if (T) {
                                    if (C.pos == M.pos)
                                        (O && S <= 11 && 0 == C.parentOffset && (e.domObserver.suppressSelectionUpdates(), setTimeout(() => ew(e), 20)),
                                        ...
                                        })(C.parent.content.cut(C.parentOffset, M.parentOffset), k.parent.content.cut(k.parentOffset, N.endA - k.start())))
                                    )
                                    ...
                                    t &&
                                        !(
                                            (x &&
                                                ...
                                                e.composing &&
                                                t.empty &&
                                                (N.start != N.endB || e.input.lastAndroidDelete < Date.now() - 100) &&
                ...
                update(e) {
                    ...
                    let t = this._props;
                    ((this._props = e), e.plugins && (e.plugins.forEach(t$), (this.directPlugins = e.plugins)), this.updateStateInner(e.state, t));
                }
                setProps(e) {
                    let t = {};
                ...
                updateStateInner(e, t) {
                    ...
                    let s = this.state,
                        r = !1,
                        l = !1;
                    (e.storedMarks && this.composing && (tn(this), (l = !0)), (this.state = e));
                    ...
                    ((d || t.handleDOMEvents != this._props.handleDOMEvents) && e2(this), (this.editable = tK(this)), tF(this));
                    let a = tM(this),
                        h = tL(this),
                        u = s.plugins == e.plugins || s.doc.eq(e.doc) ? (e.scrollToSelection > s.scrollToSelection ? "to selection" : "preserve") : "reset",
                    ...
                    if (l) {
                        ...
                        let d =
                            ...
                            !s.selection.empty &&
                            !e.selection.empty &&
                            ((o = s.selection), (i = e.selection), (l = Math.min(o.$anchor.sharedDepth(o.head), i.$anchor.sharedDepth(i.head))), o.$anchor.start(l) != i.$anchor.start(l));
                        if (f) {
                            let t = x ? (this.trackWrites = this.domSelectionRange().focusNode) : null;
                            ((r || !this.docView.update(e.doc, h, a, this)) && (this.docView.updateOuterDeco([]), this.docView.destroy(), (this.docView = ei(e.doc, h, a, this.dom, this))),
                        ...
                        !(
                            ...
                            ((t = this.docView.domFromPos(this.state.selection.anchor, 0)), (n = this.domSelectionRange()), c(t.node, t.offset, n.anchorNode, n.anchorOffset))
                        )
                            ? ew(this, d)
                ...
                updateDraggedNode(e, t) {
                    ...
                    this.dragging = new tl(e.slice, e.move, i < 0 ? void 0 : o.qv.create(this.state.doc, i));
                }
                someProp(e, t) {
                ...
                posAtCoords(e) {
                    return (function (e, t) {
                        ...
                        if (T) for (let e = h; r && e; e = l(e)) e.draggable && (r = void 0);
                        if (((h = (o = (n = h).parentNode) && /^li$/i.test(o.nodeName) && t.left < n.getBoundingClientRect().left ? o : n), r)) {
                            let n;
                            if (C && 1 == r.nodeType && (d = Math.min(d, r.childNodes.length)) < r.childNodes.length) {
                                let e = r.childNodes[d],
                                    n;
                                "IMG" == e.nodeName && (n = e.getBoundingClientRect()).right <= t.left && n.bottom > t.top && d++;
                            }
                            (R && d && 1 == r.nodeType && 1 == (n = r.childNodes[d - 1]).nodeType && "false" == n.contentEditable && n.getBoundingClientRect().top >= t.top && d--,
                                    ...
                                    : (0 == d || 1 != r.nodeType || "BR" != r.childNodes[d - 1].nodeName) &&
                                      (i = (function (e, t, n, o) {
                                          ...
                                          for (let n = t, s = !1; n != e.dom; ) {
                                              ...
                                              if (!t) return null;
                                              if (1 == t.dom.nodeType && ((t.node.isBlock && t.parent && !s) || !t.contentDOM)) {
                                                  let e = t.dom.getBoundingClientRect();
                                                  if (
                                                      (t.node.isBlock &&
                                                          t.parent &&
                                                          !s &&
                                                          ((s = !0), e.left > o.left || e.top > o.top ? (i = t.posBefore) : (e.right < o.left || e.bottom < o.top) && (i = t.posAfter)),
                                        ...
                                        for (let e = t.firstChild, u = 0; e; e = e.nextSibling, u++) {
                                            ...
                                            for (let a = 0; a < t.length; a++) {
                                                ...
                                                if (f.top <= c && f.bottom >= h) {
                                                    ...
                                                    f.top > n.top && !o && f.left <= n.left && f.right >= n.left && ((o = e), (i = { left: Math.max(f.left, Math.min(f.right, n.left)), top: f.top }));
                                        ...
                                        return (!s && o && ((s = o), (l = i), (r = 0)), s && 3 == s.nodeType)
                                            ? (function (e, t) {
                                                  ...
                                                  for (let i = 0; i < n; i++) {
                                                      ...
                                                      let n = $(o, 1);
                                                      if (n.top != n.bottom && K(t, n)) return { node: e, offset: i + (t.left >= (n.left + n.right) / 2 ? 1 : 0) };
                                                  }
                ...
                destroy() {
                    this.docView &&
                        ...
                        this.mounted ? (this.docView.update(this.state.doc, [], tM(this), this), (this.dom.textContent = "")) : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom),
                ...
                dispatchEvent(e) {
                    e3(this, e) || !eJ[e.type] || (!this.editable && e.type in eQ) || eJ[e.type](this, e);
                }
                dispatch(e) {
                ...
                domSelectionRange() {
                    return T &&
                        ...
                        ? (function (e) {
                              ...
                              return (c(l.node, l.offset, s, r) && ([o, i, s, r] = [s, r, o, i]), { anchorNode: o, anchorOffset: i, focusNode: s, focusOffset: r });
                          })(this)
                        : this.domSelection();
                }
                domSelection() {
            ...
            function tF(e) {
                if (e.markCursor) {
                    ...
                    ((t.className = "ProseMirror-separator"),
                        ...
                        t.setAttribute("alt", ""),
                        (e.cursorWrapper = { dom: t, deco: tf.widget(e.state.selection.head, t, { raw: !0, marks: e.markCursor }) }));
