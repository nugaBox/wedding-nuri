    ...
    [605],
    {
                    ...
                    return {
                        ...
                        post: function (e) {
                            if ("undefined" != typeof window)
                                try {
                                    localStorage.setItem(t, JSON.stringify(c(c({}, e), {}, { timestamp: f() })));
                                } catch (t) {}
                        },
                    };
                }),
                            ...
                            function (t) {
                                for (;;)
                                    switch ((t.prev = t.next)) {
                                        case 0:
                                            return (
                                                (u = (a = y.length > 3 && void 0 !== y[3] ? y[3] : {}).ctx),
                                                ...
                                                (d = {
                                                    headers: c(
                                                        ...
                                                        null != s && null !== (p = s.headers) && void 0 !== p && p.cookie ? { cookie: s.headers.cookie } : {}
                                                    ),
                                                }),
                                                null != s && s.body && ((d.body = JSON.stringify(s.body)), (d.method = "POST")),
                                                (t.next = 7),
                                                fetch(f, d)
                                            );
                                        case 7:
                                        ...
                                        case 16:
                                            return ((t.prev = 16), (t.t0 = t.catch(2)), n.error("CLIENT_FETCH_ERROR", { error: t.t0, url: f }), t.abrupt("return", null));
                                        case 20:
                                        case "end":
                                            return t.stop();
                                    }
        ...
        60026: function (t, e, r) {
                                                ...
                                                for (;;)
                                                    switch ((r.prev = r.next)) {
                                                        case 0:
                                                            ...
                                                            return (e.debug("adapter_".concat(n), { args: u }), (c = t[n]), (r.next = 6), c.apply(void 0, u));
                                                        case 6:
                                                        ...
                                                        case 9:
                                                            throw (
                                                                ...
                                                                ((s = new v(r.t0)).name = "".concat(g(n), "Error")),
                                                                s
                                                            );
                                                        case 15:
                                                        case "end":
            ...
            var v = (e.UnknownError = (function (t) {
                function e(t) {
                    ...
                    return (
                        (0, i.default)(this, e),
                        ((n = d(this, e, [null !== (r = null == t ? void 0 : t.message) && void 0 !== r ? r : t])).name = "UnknownError"),
                        (n.code = t.code),
            ...
            ((e.OAuthCallbackError = (function (t) {
                ...
                (e.AccountNotLinkedError = (function (t) {
                    function e() {
                        var t;
                        (0, i.default)(this, e);
                        for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                (e.MissingAdapterMethods = (function (t) {
                    function e() {
                        var t;
                        (0, i.default)(this, e);
                        for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                (e.UnsupportedStrategy = (function (t) {
                    function e() {
                        var t;
                        (0, i.default)(this, e);
                        for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
                ...
                (e.InvalidCallbackUrl = (function (t) {
                    function e() {
                        var t;
                        (0, i.default)(this, e);
                        for (var r = arguments.length, n = Array(r), o = 0; o < r; o++) n[o] = arguments[o];
        ...
        80605: function (t, e, r) {
            ...
            var n,
                ...
                l = r(22053);
            Object.defineProperty(e, "__esModule", { value: !0 });
            var f = { SessionContext: !0, useSession: !0, getSession: !0, getCsrfToken: !0, getProviders: !0, signIn: !0, signOut: !0, SessionProvider: !0 };
            ((e.SessionContext = void 0),
                (e.SessionProvider = function (t) {
                                            ...
                                            for (;;)
                                                switch ((t.prev = t.next)) {
                                                    case 0:
                                                        ...
                                                        return ((j._lastSync = (0, x.now)()), (t.next = 7), R({ broadcast: !r }));
                                                    case 7:
                    ...
                    var T =
                            ((e = y.useState("undefined" != typeof navigator && navigator.onLine)),
                                            ...
                                            return p.default.wrap(function (e) {
                                                for (;;)
                                                    switch ((e.prev = e.next)) {
                                                        ...
                                                        case 15:
                                                            return ((r = e.sent), S(!1), r && (m(r), k.post({ event: "session", data: { trigger: "getSession" } })), e.abrupt("return", r));
                                                        case 19:
                                                        case "end":
                                                            return e.stop();
                                                    }
                    ...
                    return (0, w.jsx)(P.Provider, { value: U, children: i });
                }),
                (e.getCsrfToken = M),
                (e.getProviders = U),
                (e.getSession = R),
                ...
                (e.useSession = function (t) {
                    ...
                    return (y.useEffect(
                        function () {
                            if (a) {
                                var t = "/api/auth/signin?".concat(new URLSearchParams({ error: "SessionRequired", callbackUrl: window.location.href }));
            ...
            Object.keys(m).forEach(function (t) {
                !("default" === t || "__esModule" === t || Object.prototype.hasOwnProperty.call(f, t)) &&
                    ((t in e && e[t] === m[t]) ||
                            ...
                            for (;;)
                                switch ((t.prev = t.next)) {
                                    ...
                                    case 2:
                                        return (
                                            (n = t.sent),
                                            (null === (r = null == e ? void 0 : e.broadcast) || void 0 === r || r) && k.post({ event: "session", data: { trigger: "getSession" } }),
                                            t.abrupt("return", n)
                                        );
                                    case 5:
                                    case "end":
                        ...
                        return p.default.wrap(function (t) {
                            for (;;)
                                switch ((t.prev = t.next)) {
                                    case 0:
                                        return (
                                            (u = void 0 === (a = (o = null != r ? r : {}).callbackUrl) ? window.location.href : a),
                                    ...
                                    case 8:
                                        ...
                                        return ((window.location.href = "".concat(s, "/signin?").concat(new URLSearchParams({ callbackUrl: u }))), t.abrupt("return"));
                                    case 11:
                                        return (
                                    ...
                                    case 46:
                                        return t.abrupt("return", { error: _, status: g.status, ok: g.ok, url: _ ? null : b.url });
                                    case 47:
                                    case "end":
                                        return t.stop();
                                }
                        ...
                        return p.default.wrap(function (t) {
                            for (;;)
                                switch ((t.prev = t.next)) {
                                    case 0:
                                        return (
                                            (o = void 0 === (n = (null != e ? e : {}).callbackUrl) ? window.location.href : n),
                                            (a = (0, x.apiBaseUrl)(j)),
                                    ...
                                    case 16:
                                        if (((c = t.sent), k.post({ event: "session", data: { trigger: "signout" } }), !(null === (r = null == e ? void 0 : e.redirect) || void 0 === r || r))) {
                                            t.next = 23;
                                            break;
                                        }
                                            ...
                                            return o.default.wrap(function (r) {
                                                for (;;)
                                                    switch ((r.prev = r.next)) {
                                                        ...
                                                        case 8:
                                                            return ((r.next = 10), fetch(i, { method: "POST", body: f, keepalive: !0 }));
                                                        case 10:
                                                            return r.abrupt("return", r.sent);
                                                        case 11:
                                                        case "end":
        ...
        97211: function (t, e, r) {
            ...
            function o() {
                ...
                function d(t, r, n, o) {
                    var a,
                        u,
                        c = Object.create((r && r.prototype instanceof x ? r : x).prototype);
                    return (
                        i(c, "_invoke", {
                            value:
                                ((a = new R(o || [])),
                                        ...
                                        if (i) {
                                            var c = (function t(r, n) {
                                                ...
                                                if (a === e)
                                                    return (
                                                        (n.delegate = null),
                                                        ("throw" === o && r.iterator.return && ((n.method = "return"), (n.arg = e), t(r, n), "throw" === n.method)) ||
                                                            ("return" !== o && ((n.method = "throw"), (n.arg = TypeError("The iterator does not provide a '" + o + "' method")))),
                                                        b
                                                    );
                                                ...
                                                return i
                                                    ? i.done
                                                        ? ((n[r.resultName] = i.value), (n.next = r.nextLoc), "return" !== n.method && ((n.method = "next"), (n.arg = e)), (n.delegate = null), b)
                                                        : i
                ...
                function T(t) {
                    if (t || "" === t) {
                        ...
                        if (!isNaN(t.length)) {
                            var o = -1,
                                a = function r() {
                                    for (; ++o < t.length; ) if (u.call(t, o)) return ((r.value = t[o]), (r.done = !1), r);
                ...
                return (
                    ...
                    i(m, "constructor", { value: w, configurable: !0 }),
                    ...
                    (R.prototype = {
                        ...
                        delegateYield: function (t, r, n) {
                            return ((this.delegate = { iterator: T(t), resultName: r, nextLoc: n }), "next" === this.method && (this.arg = e), b);
                        },
                    }),
                    r
                );
