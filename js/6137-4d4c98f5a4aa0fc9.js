        ...
        53335: function (e, r, o) {
            ...
            let T = (function (e, ...r) {
                            ...
                            splitModifiers: (function (e) {
                                ...
                                return function (e) {
                                    ...
                                    let c = 0 === i.length ? e : e.substring(a),
                                        d = c.startsWith("!"),
                                        u = d ? c.substring(1) : c;
                                    return { modifiers: i, hasImportantModifier: d, baseClassName: u, maybePostfixModifierPosition: l && l > a ? l - a : void 0 };
                                };
                            })(i),
                            ...(function (e) {
                                let r = (function (e) {
                                        ...
                                        return (
                                            ...
                                            t
                                                ? r.map(([e, r]) => [
                                                      e,
                                                      r.map(e => ("string" == typeof e ? t + e : "object" == typeof e ? Object.fromEntries(Object.entries(e).map(([e, r]) => [t + e, r])) : e)),
                                                  ])
                                                : r).forEach(([e, r]) => {
                                                (function e(r, o, t, l) {
                                                    r.forEach(r => {
                                    ...
                                    { conflictingClassGroups: o, conflictingClassGroupModifiers: l } = e;
                                return {
                                    getClassGroupId: function (e) {
                                        ...
                                        return (
                                            ...
                                            (function e(r, o) {
                                                ...
                                                let i = r.join("-");
                                                return o.validators.find(({ validator: e }) => e(i))?.classGroupId;
                                            })(o, r) ||
                                                (function (e) {
                                                    if (t.test(e)) {
                                                        let r = t.exec(e)[1],
                ...
                function d(e) {
                    ...
                    if (r) return r;
                    let t = (function (e, r) {
                        let { splitModifiers: o, getClassGroupId: t, getConflictingClassGroupIds: n } = r,
                            i = new Set();
                        return e
                            .trim()
                            .split(l)
                            .map(e => {
                                let { modifiers: r, hasImportantModifier: n, baseClassName: l, maybePostfixModifierPosition: i } = o(e),
                                    s = t(i ? l.substring(0, i) : l),
                                    a = !!i;
                                if (!s) {
                                    if (!i || !(s = t(l))) return { isTailwindClass: !1, originalClassName: e };
                                    a = !1;
                                }
                                let c = (function (e) {
                                ...
                                return { isTailwindClass: !0, modifierId: n ? c + "!" : c, classGroupId: s, originalClassName: e, hasPostfixModifier: a };
                            })
                            .reverse()
                            .filter(e => {
                                if (!e.isTailwindClass) return !0;
                                let { modifierId: r, classGroupId: o, hasPostfixModifier: t } = e,
                                    l = r + o;
                ...
                return {
                    ...
                    classGroups: {
                        ...
                        w: [{ w: ["auto", "min", "max", "fit", "svw", "lvw", "dvw", k, r] }],
                        "min-w": [{ "min-w": [k, r, "min", "max", "fit"] }],
                        "max-w": [{ "max-w": [k, r, "none", "full", "min", "max", "fit", "prose", { screen: [z] }, z] }],
                        h: [{ h: [k, r, "auto", "min", "max", "fit", "svh", "lvh", "dvh"] }],
                        "min-h": [{ "min-h": [k, r, "min", "max", "fit", "svh", "lvh", "dvh"] }],
                        "max-h": [{ "max-h": [k, r, "min", "max", "fit", "svh", "lvh", "dvh"] }],
                        ...
                        leading: [{ leading: ["none", "tight", "snug", "normal", "relaxed", "loose", g, k] }],
                        ...
                        "text-decoration-thickness": [{ decoration: ["auto", "from-font", g, h] }],
